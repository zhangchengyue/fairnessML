...
CleanGenderVar <- function(column){
    ...
    # If the value is 2, then it is LGBTQ, indicate them as "Other", otherwise:
      # if the value is 1, then it is Female, otherwise:
        # if the value is 0, then it is Male, otherwise, indicate as "Other".
