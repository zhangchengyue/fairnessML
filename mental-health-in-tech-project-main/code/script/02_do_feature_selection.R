...
clean_df <-  read.csv("./data/processed_data/mental-health-in-tech-2016-clean.csv")
...
View(dummy_df)
dummy_df[1:3, c(156:157)]


#feature importance------------------------------------------------------------------------------------------
library(FSelector)
#initial look at potentially significant features with chi squared
weights <- FSelector::chi.squared(mh_discussion_negative ~., dummy_df[, -c(156:157)])

print(weights)

subset<- FSelector::cutoff.k(weights, 20)
f <- as.simple.formula(subset, "Class")
print(f) 

####################################################################################################
#in descending order of importance: 
# mh_discussion_supervisor.Yes + 
# mh_discussion_supervisor.No + 
# ph_discussion_negative.No +
# mh_ph_serious.Yes + 
# mh_id_coworkers_impact.Yes..I.think.they.would + 
# mh_discussion_coworkers.No +
# mh_medical_leave.Very.easy + 
# ph_discussion_negative.Maybe + 
# mh_id_career_impact.Yes..I.think.it.would +
# mh_ph_serious.No + 
# mh_medical_leave.Very.difficult + 
# mh_id_coworkers_impact.No..I.don.t.think.they.would +
# mh_discussion_coworkers.Yes + 
# mh_id_career_impact.No..I.don.t.think.it.would +
# mh_interview.No + 
# previous_employers_mh_discuss_impact.Yes..all.of.them +
# mh_id_career_impact.Maybe + 
# mh_other_impact.Yes + 
# mh_medical_leave.Somewhat.difficult + 
# mh_unsupportive_workplace.No
####################################################################################################
...
# write_csv(dummy_df, path = "./data/processed_data/mental-health-in-tech-2016-modeling.csv")
